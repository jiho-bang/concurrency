...
public class LockUtil {
    ...
    public static void ensureSufficientLockHeld(LockContext lockContext, LockType requestType) {
        ...
        if (requestType.equals(LockType.S)) {
            ensureAncestors(requestType, parentContext, transaction);
    ...
    private static void ensureAncestors(LockType lockType, LockContext parent, TransactionContext transaction) {
        ...
        for (LockContext p : parents) {
            LockType type = p.getExplicitLockType(transaction);
            if (lockType.equals(LockType.S)) {
                ...
                } else if (type.equals(LockType.S)) {
